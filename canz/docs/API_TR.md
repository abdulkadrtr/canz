...
Bu depo [White Paper Linki] teknik raporuyla tanıtılan canz veri sıkıştırma algoritmasının C implementasyonunu içerir.
...
INI formatında, `#` ile yorum satırı oluşturulur.
